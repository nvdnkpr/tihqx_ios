...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','net.iamyellow.tihqx.js')
	...
	f = os.path.join(cwd,'Classes','NetIamyellowTihqxModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','net.iamyellow.tihqx.js']
